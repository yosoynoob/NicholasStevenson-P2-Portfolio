...
```{r}
p5 <- mydata %>% ggplot(aes(x=Age, y=Height)) + geom_boxplot()
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","Age-Height.png")
...
p6 <- mydata %>% ggplot(aes(x=Weight, y=Dating_App)) + geom_point()
plot(p6)
figure_file = here("starter-analysis-exercise","results","figures","Dating_App-weight.png")
