---
title: "Exploratory analysis script - Assignment 2"
...
```{r}
#Once values are added to the dating app and age variable, this will generate the graph showing the relationship
p5 <- mydata %>% ggplot(aes(x=`Dating App`, y=Age)) + geom_boxplot()
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","dating-age.png")
ggsave(filename = figure_file, plot=p5) 
```
```{r}
#Once values are added to the age variable, this will generate the graph showing the relationship
